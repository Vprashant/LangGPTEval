...
Welcome to **LangGPTEval**, a sophisticated evaluation library designed for Retrieval-Augmented Generation (RAG) responses. This library provides powerful tools for evaluating the faithfulness, context recall, answer relevancy, and context relevancy of responses generated by various models, including OpenAI, Azure, and custom models. With a complex architecture and advanced Pydantic validation, LangGPTEval ensures reliable and accurate evaluation metrics.
